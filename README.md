...
Based on customer reviews provided by Skytrax, the average flight rating is low, ranging from 3.46 (customers who travel for business) to 4.96 (customers who travel for leisure by themselves) out of 10. Approximately 65% of customers who have reviewed their experience would not recommend their specific flight. Customers who travel for business are highly dissatisfied and consistently gave the lowest scores across every single service category, showing a severe disconnect in premium tier expectations.

Cabin Staff Service is the highest-rated category across all travel segments, maintaining a weighted average of 3.15/5. Value for Money is the lowest-rated element overall (2.51/5 weighted average), plummeting to a critical 2.09/5 among Business Class travelers.
Average flight ratings show a drop from a positive 6.11/10 in 2014 down to 3.66/10 in 2024, highlighting an institutional decline in customer satisfaction over the last decade. The year 2017 marked a massive drop in sentiment, with the rating plummeting from 4.84 to 3.86, signaling major operational changes or cost-cutting measures that deeply alienated passengers.

June represents a massive service pain point. It holds the lowest average flight rating (3.96/10) of the entire year, indicating severe operational stress, delays, or capacity issues as summer travel surges. October delivers the highest average flight rating (4.56/10), closely followed by January (4.53) and December (4.51). Off-peak autumn travel yields significantly higher customer satisfaction.

The airline is split with 49.81% positive (1,557 reviews) and 43.31% negative (1,354 reviews) sentiments, indicating an erratic customer experience. Although nearly half of the reviews are marked positive, the average annual flight ratings (3.66 in 2024), indicates that even positive reviewers often leave low quantitative scores due to underlying product defects.

Word cloud indicate that customers prioritize seat comfort, food and drink quality, crew/staff service, how their time is being spent, and baggage and check in. The high frequency of "seat", "food", and "service" confirms that service and catering elements heavily dictate overall customer perception. The presence of "time" and "hour" highlights that delays, scheduling friction, and long wait times are main topics in text reviews. The word "staff" matches the high cabin service scores, showing that human interaction remains a primary topic of discussion in customer feedback. The appearance of "Business Class" as a top-10 phrase proves that passengers travelling for business are vocal in the review text, aligning with their dissatisfaction scores.

Recommendations:
* Minimize the Business Class comfort deficit by improving business class seating and in-flight entertainment. Launch an cabin retrofitting program for business class seats, focusing on workspace utility, cushion density, etc. Upgrade the digital catalog and touchscreen hardware, focusing on high-definition displays and modern connectivity options for corporate travelers.
* Address review complaints about "time", "hour", and "check" by introducing dedicated premium check-in lanes, biometric boarding, and priority security queues to improve the ground service rating.
* Reallocate catering budgets to overhaul Business Class menus. Partner with premium culinary brands and improve the temperature and presentation of meals on long-haul routes, to improve food and drinks rating.
* Introduce tangible premium perks, such as flexible ticket changes, complimentary high-speed Wi-Fi, or exclusive lounge arrival showers, to imporve the value for money rating.
* Mitigate June operational slump by deploy predictive staffing and maintenance models specifically targeted at peak summer travel windows to eliminate the seasonal drop in flight rating.
* The airline's highest rated service category is the cabin staff service. Keep cabin service rating hhigh by optimizing crew schedules during high-volume periods (September and October) to prevent burnout and protect service quality.
